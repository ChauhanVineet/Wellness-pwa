...
export function ExerciseIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M6.5 6.5 17.5 17.5" />
      <path d="M4 4l3 3M20 20l-3-3" />
      <rect x="2.5" y="2.5" width="4" height="4" rx="1" transform="rotate(45 4.5 4.5)" />
      <rect x="17.5" y="17.5" width="4" height="4" rx="1" transform="rotate(45 19.5 19.5)" />
    </svg>
  )
}
